...
def main():
  ...
  if dados['tipo_plot'] == '2d':
    ...
    if dados['variavel'] == 't':
      resultado = obter_dado_J_e_N(dados['intervalo'], dados['numero'], dados['energia_atrativa'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)
      ...
      resultado = obter_dado_T_e_N(dados['intervalo'], dados['temperatura'], dados['numero'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)
      ...
      resultado = obter_dado_T_e_J(dados['intervalo'], dados['temperatura'], dados['energia_atrativa'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)
      plot2D('n', dados['intervalo'], 'Δ', resultado['deltas'], f'com J = {dados["energia_atrativa"]} e T = {dados["temperatura"]}K', show=dados['display'])
      plot2D('n', dados['intervalo'], 'µ', resultado['energia_quimica'], f'com J = {dados["energia_atrativa"]} e T = {dados["temperatura"]}K', show=dados['display'])      
    ...
    if dados['constante'] == 't':
      ...
      resultado = obter_dado_T(dados['Temperatura'], dados['intervalo_numero'], dados['intervalo_energia_atrativa'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)
      ...
      resultado = obter_dado_J(dados['Energia Atrativa'], dados['intervalo_numero'], dados['intervalo_temperatura'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)
      plot3D('T', X, 'n', Y, 'Δ', np.array(resultado['Delta']), f' com J = {dados["Energia Atrativa"]}', show=dados['display'])
      ...
      resultado = obter_dado_N(dados['intervalo_energia_atrativa'], dados['Número'], dados['intervalo_temperatura'], n, D, Potencial_Quimico, B, K, Delta, Dimensao, Sitios, f, M)  
